            ...
            <section id="footer-settings" className="bg-white rounded-xl shadow-2xl p-6 mb-8">
                                ...
                                <div key={index} className="mb-4 p-4 bg-white rounded-lg shadow-sm flex flex-col sm:flex-row items-center gap-4">
                                    <div className="flex items-center gap-2 w-full sm:w-[180px]">
                                        ...
                                        <select
                                            ...
                                            className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent h-[48px]" // Match height with inputs
                                        >
                                    ...
                                    <input
                                        ...
                                        className="w-full sm:w-1/3 p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent h-[48px]" // Consistent height
                                    />
                                    <input
                                        type="text"
                                        placeholder="Link"
                ...
                <div className="mt-8">
                    <button
                        ...
                        className="w-full py-3 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors shadow-md font-semibold"
                    >
                        Save All Settings
                    </button>
                </div>
