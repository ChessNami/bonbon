                ...
                >
                    ...
                    >
                        <div className="flex justify-between items-center p-6 border-b border-gray-200 bg-gray-50">
                            <h2 className="text-xl sm:text-2xl font-bold text-gray-900 tracking-tight">Update Requests</h2>
                            <motion.button
                                onClick={onClose}
                        ...
                        <div className="flex-1 overflow-y-auto p-6">
                            {sortedResidents.length > 0 ? (
                                    ...
                                    >
                                                ...
                                                <div>
                                                    ...
                                                    {resident.updateReason && (
                                                        <p className="text-sm text-gray-600 mt-1">
                                                            <span className="font-medium">Reason:</span> {resident.updateReason}
                                                        </p>
                                                    )}
                                                    {resident.createdAt && (
                                                        <p className="text-sm text-gray-600 mt-1">
                                        ...
                                        {showRejectionForm === resident.id && (
                                            <div className="mt-4 p-4 bg-white rounded-lg border border-gray-200">
                                                <h4 className="text-sm font-semibold text-gray-800 mb-3">Reason for Declining</h4>
                                                <textarea
                                ...
                                <p className="text-sm text-gray-500 text-center italic">No update requests at this time.</p>
                            )}
                        </div>
                    </div>
                </motion.div>
