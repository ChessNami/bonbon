...
import { FaCheck, FaBan, FaSyncAlt } from 'react-icons/fa';
import { motion } from 'framer-motion';

const HeaderControls = ({ pendingCount, rejectedCount, requestsCount, onPending, onRejected, onRequests, onReload }) => {
    return (
