...
const HeaderControls = ({ pendingCount, rejectedCount, requestsCount, updateProfilingCount, onPending, onRejected, onRequests, onUpdateProfiling, onReload }) => {
    return (
            ...
            <div className="flex flex-wrap items-center gap-4">
                ...
                >
                    ...
                    {updateProfilingCount > 0 && (
                        <span className="absolute -top-2 -right-2 bg-purple-500 text-white text-xs font-semibold rounded-full h-5 w-5 flex items-center justify-center shadow-md">
